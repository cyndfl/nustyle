...
<div class="btn">
    <a class="btn-default" href="appointment.php">BOOK AN APPOINTMENT</a>
</div>
...
<section class="welcome">
    ...
    <div class="btn_welcome">
        <a class="btn-default" href="about.php">READ MORE</a>
    </div>
...
<!--SERVICES-->
        <div class="services col-md-4">
            <a href="services.php"><img src="assets/img/services.jpg" alt=""><b>SERVICES</b></a>
</div>
<!--PRODUCTS-->
        <div class="products col-md-4">
            <a href="" data-toggle="modal" data-target="#myModalProd"><img src="assets/img/product.jpg" alt=""><b>PRODUCTS</b></a>
...
<!--MODAL-PRODUCTS -->
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="card col-md-6">
                                    <img src="assets/img/prod.gif" alt="">
                                ...
                                <div class="card col-md-6">
                                    <img src="assets/img/prod2.gif" alt="">
        ...
        <div class="style">
            ...
            <a href="" data-toggle="modal" data-target="#myModal"><img src="assets/img/stylist.jpg" alt=""><b>STYLIST</b></a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="card col-md-6">
                                    <img src="assets/img/stylist6.jpg" alt="">
